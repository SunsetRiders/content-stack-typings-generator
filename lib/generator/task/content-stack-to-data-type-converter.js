...
function convertAllToDataType(contentTypes) {
    ...
    library.createTypeDefinition('File', [
        new object_model_1.DataTypeField('file', 'string', false),
        new object_model_1.DataTypeField('link', 'string', false),
        new object_model_1.DataTypeField('image_thumbnail', 'string', false),
        new object_model_1.DataTypeField('file_detail', 'string', false),
        new object_model_1.DataTypeField('title', 'string'),
        new object_model_1.DataTypeField('text', 'string', false),
        new object_model_1.DataTypeField('button_label', 'string', false),
